...
import { MdDevices,MdFactory } from 'react-icons/md';
                    ...
                    <ul className="nav nav-pills flex-column">
                        ...
                        <li className="nav-item">
                            <a 
                                href="#" 
                                className="nav-link d-flex align-items-center justify-content-between"
                                onClick={(e) => { e.preventDefault(); toggleMenu('fabricantes'); }}
                            >
                                <div className="d-flex align-items-center">
                                    <MdFactory className="nav-icon me-3" /> 
                                    <span>Fabricantes</span>
                                </div>
                                <FiChevronRight className={`transition-all ${openMenus['fabricantes'] ? 'rotate-90' : ''}`} />
                            </a>
                            <ul className={`nav flex-column ps-4 ${openMenus['fabricantes'] ? 'd-block' : 'd-none'}`}>
                                <li className="nav-item">
                                    <Link to="/listfabricantes" className="nav-link d-flex align-items-center">
                                        <FiList className="nav-icon me-3" />
                                        <span>Listado</span>
                                    </Link>
                                </li>
